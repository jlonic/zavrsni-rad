...
const User = () => {
    ...
    useEffect(() => {
        ...
        const fetchUserAndFollowStatus = async () => {
            ...
            try {
                const userResponse = await fetch(`https://zavrsni-rad-backend-3u9x.onrender.com/users/${username}`, {
                    method: 'GET',
                    headers: {
                ...
                if (userResponse.ok) {
                    setUser(userData[0]);
                    const followStatusResponse = await fetch(`https://zavrsni-rad-backend-3u9x.onrender.com/follows/checkFollowStatus/${userData[0].user_id}`, {
                        method: 'GET',
                        headers: {
                            'Content-Type': 'application/json',
        ...
        const fetchUserFavorites = async () => {
            const token = localStorage.getItem('token');
            try {
                const response = await fetch(`https://zavrsni-rad-backend-3u9x.onrender.com/favorites/user-favorite-albums/${username}`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': `Bearer ${token}`,
            ...
            try {
                const response = await fetch(`https://zavrsni-rad-backend-3u9x.onrender.com/favorites/user-favorite-tracks/${username}`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': `Bearer ${token}`,
        ...
        const recentlyReviewed = async () => {
            const token = localStorage.getItem('token');
            try {
                const response1 = await fetch(`https://zavrsni-rad-backend-3u9x.onrender.com/reviews/artist-reviews/${username}`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': `Bearer ${token}`,
                ...
                const response2 = await fetch(`https://zavrsni-rad-backend-3u9x.onrender.com/reviews/album-reviews/${username}`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': `Bearer ${token}`,
                ...
                const response3 = await fetch(`https://zavrsni-rad-backend-3u9x.onrender.com/reviews/track-reviews/${username}`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': `Bearer ${token}`,
    ...
    const followUser = async () => {
        const token = localStorage.getItem('token');
        try {
            const response = await fetch('https://zavrsni-rad-backend-3u9x.onrender.com/follows/followUser', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    Authorization: `Bearer ${token}`
    ...
    const unfollowUser = async () => {
        const token = localStorage.getItem('token');
        try {
            const response = await fetch('https://zavrsni-rad-backend-3u9x.onrender.com/follows/unfollowUser', {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json',
                    Authorization: `Bearer ${token}`
                    ...
                    <>
                        <div className="flex justify-between items-center">
                            <div className="flex items-center">
                                <img src={`https://zavrsni-rad-backend-3u9x.onrender.com${user.profile_picture}`} alt='' className='h-48 w-48 rounded-full' />
                                <br />
