...
const Dashboard = () => {
  ...
  const getFollows = useCallback(async () => {
    try {
      const response = await fetch(`https://zavrsni-rad-backend-3u9x.onrender.com/follows/getFollows`, {
        method: 'GET',
        headers: {
  ...
  const recentlyReviewed = async (follows) => {
    ...
    try {
      for (let i = 0; i < follows.length; i++) {
        const response1 = await fetch(`https://zavrsni-rad-backend-3u9x.onrender.com/reviews/artist-reviews/${follows[i].username}`, {
          method: 'GET',
          headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${token}`,
        ...
        const response2 = await fetch(`https://zavrsni-rad-backend-3u9x.onrender.com/reviews/album-reviews/${follows[i].username}`, {
          method: 'GET',
          headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${token}`,
        ...
        const response3 = await fetch(`https://zavrsni-rad-backend-3u9x.onrender.com/reviews/track-reviews/${follows[i].username}`, {
          method: 'GET',
          headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${token}`,
