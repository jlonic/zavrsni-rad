...
const Admin = () => {
    ...
    const addArtist = async (artist_name) => {
        ...
        try {
            const response = await fetch(`https://zavrsni-rad-backend-gdih.onrender.com/admin/add-artist/`, {
                method: 'POST',
                headers: {
    ...
    const addArtistManually = async (e) => {
        ...
        const token = localStorage.getItem('token');
        try {
            const response = await fetch(`https://zavrsni-rad-backend-gdih.onrender.com/artists/add`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer: ${token}`,
    ...
    const getArtistById = async (e) => {
        ...
        const token = localStorage.getItem('token');
        try {
            const response = await fetch(`https://zavrsni-rad-backend-gdih.onrender.com/artists/${artistId}`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                },
            ...
            if (response.ok) {
                ...
                const softDeletedArtist = await fetch(`https://zavrsni-rad-backend-gdih.onrender.com/artists/soft-deleted/${artistId}`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': `Bearer: ${token}`,
    ...
    const getArtistByName = async (e) => {
        ...
        const token = localStorage.getItem('token');
        try {
            const response = await fetch(`https://zavrsni-rad-backend-gdih.onrender.com/artists/name/${artist_name}`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer: ${token}`,
    ...
    const updateArtist = async (e) => {
        ...
        const token = localStorage.getItem('token');
        try {
            const response = await fetch(`https://zavrsni-rad-backend-gdih.onrender.com/artists/update/${artistId}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer: ${token}`,
    ...
    const softDeleteArtist = async (e) => {
        ...
        const token = localStorage.getItem('token');
        try {
            const response = await fetch(`https://zavrsni-rad-backend-gdih.onrender.com/artists/soft-delete/${artistId}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer: ${token}`,
    ...
    const restoreArtist = async (e) => {
        ...
        const token = localStorage.getItem('token');
        try {
            const response = await fetch(`https://zavrsni-rad-backend-gdih.onrender.com/artists/restore/${artistId}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer: ${token}`,
    ...
    const getAllArtists = async () => {
        ...
        try {
            const response = await fetch(`https://zavrsni-rad-backend-gdih.onrender.com/artists/all`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer: ${token}`,
    ...
    const deleteArtist = async (e) => {
        ...
        const token = localStorage.getItem('token');
        try {
            const response = await fetch(`https://zavrsni-rad-backend-gdih.onrender.com/artists/delete-all-data/${artistId}`, {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer: ${token}`,
    ...
    const addAlbum = async (e) => {
        ...
        const token = localStorage.getItem('token');
        try {
            const response = await fetch(`https://zavrsni-rad-backend-gdih.onrender.com/albums/add`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer: ${token}`,
    ...
    const getAlbumByTitle = async (e) => {
        ...
        const token = localStorage.getItem('token');
        try {
            const response = await fetch(`https://zavrsni-rad-backend-gdih.onrender.com/albums/title/${album_title}`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer: ${token}`,
    ...
    const updateAlbum = async (e) => {
        ...
        const token = localStorage.getItem('token');
        try {
            const response = await fetch(`https://zavrsni-rad-backend-gdih.onrender.com/albums/update/${album_id}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer: ${token}`,
    ...
    const softDeleteAlbum = async (e) => {
        ...
        const token = localStorage.getItem('token');
        try {
            const response = await fetch(`https://zavrsni-rad-backend-gdih.onrender.com/albums/soft-delete/${album_id}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer: ${token}`,
    ...
    const restoreAlbum = async (e) => {
        ...
        const token = localStorage.getItem('token');
        try {
            const response = await fetch(`https://zavrsni-rad-backend-gdih.onrender.com/albums/restore/${album_id}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer: ${token}`,
    ...
    const deleteAlbum = async (e) => {
        ...
        const token = localStorage.getItem('token');
        try {
            const response = await fetch(`https://zavrsni-rad-backend-gdih.onrender.com/albums/delete-all-data/${album_id}`, {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer: ${token}`,
    ...
    const getAllAlbums = useCallback(async (page = 0) => {
        ...
        const token = localStorage.getItem('token');
        try {
            const response = await fetch(`https://zavrsni-rad-backend-gdih.onrender.com/albums/getAll/${limit}/${offset}`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer: ${token}`,
    ...
    const getAllAlbumsByArtist = async (e) => {
        ...
        const token = localStorage.getItem('token');
        try {
            const response = await fetch(`https://zavrsni-rad-backend-gdih.onrender.com/albums/artist-name/${artist_name}`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer: ${token}`,
    ...
    const addTrack = async (e) => {
        ...
        const token = localStorage.getItem('token');
        try {
            const response = await fetch(`https://zavrsni-rad-backend-gdih.onrender.com/tracks/add`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer: ${token}`,
    ...
    const getTrackById = async (e) => {
        ...
        const token = localStorage.getItem('token');
        try {
            const response = await fetch(`https://zavrsni-rad-backend-gdih.onrender.com/tracks/${track_id}`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                },
            ...
            if (response.ok) {
                ...
                const softDeletedTrack = await fetch(`https://zavrsni-rad-backend-gdih.onrender.com/tracks/soft-deleted/${track_id}`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': `Bearer: ${token}`,
    ...
    const getTrackByTrackTitle = async (e) => {
        ...
        const token = localStorage.getItem('token');
        try {
            const response = await fetch(`https://zavrsni-rad-backend-gdih.onrender.com/tracks/title/${track_title}`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer: ${token}`,
    ...
    const updateTrack = async (e) => {
        ...
        const token = localStorage.getItem('token');
        try {
            const response = await fetch(`https://zavrsni-rad-backend-gdih.onrender.com/tracks/update/${track_id}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer: ${token}`,
    ...
    const softDeleteTrack = async (e) => {
        ...
        const token = localStorage.getItem('token');
        try {
            const response = await fetch(`https://zavrsni-rad-backend-gdih.onrender.com/tracks/soft-delete/${track_id}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer: ${token}`,
    ...
    const restoreTrack = async (e) => {
        ...
        const token = localStorage.getItem('token');
        try {
            const response = await fetch(`https://zavrsni-rad-backend-gdih.onrender.com/tracks/restore/${track_id}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer: ${token}`,
    ...
    const deleteTrack = async (e) => {
        ...
        const token = localStorage.getItem('token');
        try {
            const response = await fetch(`https://zavrsni-rad-backend-gdih.onrender.com/tracks/delete/${track_id}`, {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer: ${token}`,
    ...
    const getAllTracksByAlbum = async (e) => {
        ...
        const token = localStorage.getItem('token');
        try {
            const response = await fetch(`https://zavrsni-rad-backend-gdih.onrender.com/tracks/album-name/${album_title}`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer: ${token}`,
    ...
    const getAllTracksByArtist = async (e) => {
        ...
        const token = localStorage.getItem('token');
        try {
            const response = await fetch(`https://zavrsni-rad-backend-gdih.onrender.com/tracks/artist-name/${artist_name}`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer: ${token}`,
    ...
    const getAllUsers = async () => {
        const token = localStorage.getItem('token');
        try {
            const response = await fetch(`https://zavrsni-rad-backend-gdih.onrender.com/users/all`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer: ${token}`,
    ...
    const getUserByUsername = async (e) => {
        ...
        const token = localStorage.getItem('token');
        try {
            const response = await fetch(`https://zavrsni-rad-backend-gdih.onrender.com/users/${username}`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer: ${token}`,
    ...
    const updateUser = async (e) => {
        ...
        const token = localStorage.getItem('token');
        try {
            const response = await fetch(`https://zavrsni-rad-backend-gdih.onrender.com/users/update/${userId}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer: ${token}`,
    ...
    const deleteUser = async (e) => {
        ...
        const token = localStorage.getItem('token');
        try {
            const response = await fetch(`https://zavrsni-rad-backend-gdih.onrender.com/users/delete/${userId}`, {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer: ${token}`,
    ...
    const changeUserPassword = async (e) => {
        ...
        const token = localStorage.getItem('token');
        try {
            const response = await fetch(`https://zavrsni-rad-backend-gdih.onrender.com/users/updatePassword/${userId}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer: ${token}`,
    ...
    const removeProfilePicture = async (e) => {
        ...
        const token = localStorage.getItem('token');
        try {
            const response = await fetch(`https://zavrsni-rad-backend-gdih.onrender.com/users/removeProfilePicture/${userId}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer: ${token}`,
                                ...
                                {allUsers.map((user) => (
                                    <li key={user.user_id} className="bg-gray-700 p-4 rounded-md">
                                        <div>
                                            ...
                                            <img src={`https://zavrsni-rad-backend-gdih.onrender.com${user.profile_picture}`} alt='' className="w-12 h-12 rounded-md mt-2" />
                                ...
                                <div className="mt-4 space-y-4">
                                    <form onSubmit={updateUser} className="space-y-4">
                                        ...
                                        <div className="bg-gray-700 p-4 rounded-md flex items-center justify-between">
                                            <img src={`https://zavrsni-rad-backend-gdih.onrender.com${profile_picture}`} alt='' className="w-12 h-12 rounded-md" />
