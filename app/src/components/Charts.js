...
const Charts = () => {
    ...
    useEffect(() => {
        ...
        fetchData('https://zavrsni-rad-backend-3u9x.onrender.com/charts/top-100-artists', setTopArtists);
        fetchData('https://zavrsni-rad-backend-3u9x.onrender.com/charts/top-albums', setTopAlbums);
        fetchData('https://zavrsni-rad-backend-3u9x.onrender.com/charts/global-200', setGlobal200);
        fetchData('https://zavrsni-rad-backend-3u9x.onrender.com/charts/hot-100', setHot100);
    }, []);
