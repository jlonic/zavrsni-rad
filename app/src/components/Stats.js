    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const response1 = await fetch(`https://zavrsni-rad-backend-43pq.onrender.com/reviews/top5AverageRating${selectedType}`, {
                    method: 'GET',
                    headers: {
                ...
                const response2 = await fetch(`https://zavrsni-rad-backend-43pq.onrender.com/reviews/top5MostReviewed${selectedType}`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'application/json',
                    },
                ...
                const response3 = await fetch(`https://zavrsni-rad-backend-43pq.onrender.com/reviews/latest5Revieved${selectedType}`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'application/json',
                    },
